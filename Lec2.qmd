...
## data.table syntax {#syntax-data-table .center}
...
<br> [The key idea: all tasks related to **rows** are done inside `i`.]{style="color: red;"}
...
You can use the `merge()` function from the `data.table` package to merge two datasets. <br><br>
...
-   To merge these two datasets, `student` works because it is the key column. <br>
...
<br> The topics in the second part of this lecture were more advanced, so you don’t need to memorize every function right away.<br><br>
